...
def _set_notify_handler(cli):
    ...
    async def event_handler(
        operation: str, resources: List[str], result: Dict, table, filter_dict
    ):
...
async def test_pg_notify_trigger_updates_on_task(cli, db):
    ...
    assert operation == "INSERT"
    assert resources == [
        "/flows/{flow_id}/runs/{run_number}/steps".format(**_step),
    ...
    assert operation == "INSERT"
    assert resources == [
        "/flows/{flow_id}/runs/{run_number}/tasks".format(**_task_step),
    ...
    assert operation == "INSERT"
    assert resources == [
        "/flows/{flow_id}/runs/{run_number}/tasks".format(**_task_end),
        "/flows/{flow_id}/runs/{run_number}/steps/{step_name}/tasks".format(
            **_task_end
        ),
        "/flows/{flow_id}/runs/{run_number}/steps/{step_name}/tasks/{task_id}".format(
