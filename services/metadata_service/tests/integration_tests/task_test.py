...
async def test_task_post(cli, db):
    ...
    _task = await assert_api_post_response(
        cli,
        path="/flows/{flow_id}/runs/{run_number}/steps/{step_name}/task".format(
            **_step
        ),
        payload=payload,
    ...
    _found = (
        await db.task_table_postgres.get_task(
    ...
    await assert_api_post_response(
        cli,
        path="/flows/NonExistentFlow/runs/{run_number}/steps/{step_name}/task".format(
            **_task
        ),
        payload=payload,
        status=500,
    ...
    await assert_api_post_response(
        cli,
        path="/flows/{flow_id}/runs/{run_number}/steps/nonexistent/task".format(
            **_task
        ),
        payload=payload,
        status=404,
...
async def test_task_heartbeat_post(cli, db):
    ...
    await assert_api_post_response(
        cli,
        path="/flows/{flow_id}/runs/{run_number}/steps/{step_name}/tasks/{task_id}/heartbeat".format(
            **_task
        ),
        status=200,  # why 200 instead of 201?
    )
    ...
    await assert_api_post_response(
        cli,
        path="/flows/NonExistentFlow/runs/{run_number}/steps/{step_name}/tasks/{task_id}/heartbeat".format(
            **_task
        ),
        status=404,
    )
    ...
    await assert_api_post_response(
        cli,
        path="/flows/{flow_id}/runs/1234/steps/{step_name}/tasks/{task_id}/heartbeat".format(
            **_task
        ),
        status=404,
    )
    ...
    await assert_api_post_response(
        cli,
        path="/flows/{flow_id}/runs/{run_number}/steps/nonexistent/tasks/{task_id}/heartbeat".format(
            **_task
        ),
        status=404,
    )
    ...
    await assert_api_post_response(
        cli,
        path="/flows/{flow_id}/runs/{run_number}/steps/{step_name}/tasks/1234/heartbeat".format(
            **_task
        ),
        status=404,
    )
...
async def test_tasks_get(cli, db):
    ...
    await assert_api_get_response(
        cli,
        "/flows/NonExistentFlow/runs/{run_number}/steps/{step_name}/tasks".format(
            **_first_task
        ),
        status=200,
        data=[],
    ...
    await assert_api_get_response(
        cli,
        "/flows/{flow_id}/runs/1234/steps/{step_name}/tasks".format(**_first_task),
        status=200,
        data=[],
    )
    ...
    await assert_api_get_response(
        cli,
        "/flows/{flow_id}/runs/{run_number}/steps/nonexistent/tasks".format(
            **_first_task
        ),
        status=200,
        data=[],
...
async def test_filtered_tasks_get(cli, db):
    ...
    (
        await add_metadata(
            db,
            flow_id=_first_task["flow_id"],
            run_number=_first_task["run_number"],
            step_name=_first_task["step_name"],
            task_id=_first_task["task_id"],
            metadata={"field_name": "field_a", "value": "value_a"},
        )
    )
    (
        await add_metadata(
            ...
            step_name=_first_task["step_name"],
            task_id=_first_task["task_id"],
            metadata={"field_name": "field_b", "value": "value_b"},
        )
    )
    ...
    (
        await add_metadata(
            db,
            flow_id=_second_task["flow_id"],
            run_number=_second_task["run_number"],
            step_name=_second_task["step_name"],
            task_id=_second_task["task_id"],
            metadata={"field_name": "field_a", "value": "not_value_a"},
        )
    )
    (
        await add_metadata(
    ...
    await assert_api_get_response(
        cli,
        "/flows/{flow_id}/runs/{run_number}/steps/{step_name}/filtered_tasks?metadata_field_name=field_a".format(
            **_first_task
        ),
    ...
    await assert_api_get_response(
        cli,
        "/flows/{flow_id}/runs/{run_number}/steps/{step_name}/filtered_tasks?pattern=value_b".format(
            **_first_task
        ),
        data=[task_pathspec(_first_task), task_pathspec(_second_task)],
    )
    ...
    await assert_api_get_response(
        cli,
        "/flows/{flow_id}/runs/{run_number}/steps/{step_name}/filtered_tasks?pattern=value_.*".format(
            **_first_task
        ),
        data=[task_pathspec(_first_task), task_pathspec(_second_task)],
    )
    ...
    await assert_api_get_response(
        cli,
        "/flows/{flow_id}/runs/{run_number}/steps/{step_name}/filtered_tasks?metadata_field_name=field_b&pattern=value_b".format(
            **_first_task
        ),
        data=[task_pathspec(_first_task), task_pathspec(_second_task)],
    )
    ...
    await assert_api_get_response(
        cli,
        "/flows/{flow_id}/runs/{run_number}/steps/{step_name}/filtered_tasks?metadata_field_name=field_a&pattern=not_value_a".format(
            **_first_task
        ),
    ...
    await assert_api_get_response(
        cli,
        "/flows/{flow_id}/runs/{run_number}/steps/{step_name}/filtered_tasks?metadata_field_name=field_a&pattern=value_b".format(
            **_first_task
        ),
        data=[],
    )
    ...
    await assert_api_get_response(
        cli,
        "/flows/{flow_id}/runs/{run_number}/steps/{step_name}/filtered_tasks".format(
            **_first_task
        ),
        data=[task_pathspec(_first_task), task_pathspec(_second_task)],
    )
...
async def test_filtered_tasks_mixed_ids_get(cli, db):
    ...
    _first_task = (
        await db.task_table_postgres.get_task(
            flow_id=_step["flow_id"],
            run_id=_step["run_number"],
            step_name=_step["step_name"],
            task_id="first-task-1",
            expanded=True,
        )
    ).body
    _second_task = (
    ...
    (
        await add_metadata(
            ...
            step_name=_first_task["step_name"],
            task_id=_first_task["task_id"],
            task_name=_first_task["task_name"],
            metadata={"field_name": "field_a", "value": "value_a"},
        )
    )
    (
...
async def test_task_get(cli, db):
    ...
    await assert_api_get_response(
        cli,
        "/flows/NonExistentFlow/runs/{run_number}/steps/{step_name}/tasks/{task_id}".format(
            **_task
        ),
        status=404,
    )
    await assert_api_get_response(
        cli,
        "/flows/{flow_id}/runs/1234/steps/{step_name}/tasks/{task_id}".format(**_task),
        status=404,
    )
    await assert_api_get_response(
        cli,
        "/flows/{flow_id}/runs/{run_number}/steps/nonexistent_step/tasks/{task_id}".format(
            **_task
        ),
        status=404,
    )
    await assert_api_get_response(
        cli,
        "/flows/{flow_id}/runs/{run_number}/steps/{step_name}/tasks/1234".format(
            **_task
        ),
        status=404,
    )
