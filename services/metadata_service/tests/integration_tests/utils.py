...
async def assert_api_get_response(
    cli,
    path: str,
    status: int = 200,
    data: object = None,
...
async def assert_api_patch_response(
    cli,
    path: str,
    payload: object = None,
    status: int = 200,
